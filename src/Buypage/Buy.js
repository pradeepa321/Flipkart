...
const Buy = () => {
    ...
    // const [inCre,setIncre] = useState (removeCart());
    // console.log(inCre);
                    ...
                    {[buy]?.map((value,index) => {
                        ...
                        <div className='buy-detail'>
                            <div className='buy-log'>
                                ...
                                <h4>LOGIN</h4>
                                <p>Pradeepa M <span>+9087654321</span></p>
                                </div>
                        ...
                        <div className='buy-detail'>
                            <div className='buy-log'>
                                ...
                                <p>Pradeepa <span>79/15, Alangulam Road, Keelapavoor.</span></p>
                                </div>
